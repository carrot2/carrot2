...
- RCP/Platform SDK for All Platforms (aka delta pack): all the above, necessary for building 
products for several platforms).

Platform package has more plugins than RCP, workbench might be needing some of them in the future.
Download page:
...
3. Copy org.junit4 plugin from your development platform (needed because of *TestBase in
org.carrot2.org) to plugins directory in target platform.
...
6. Go to org.carrot2.workbench.core project, open Workbench.product file, on Overview page, in

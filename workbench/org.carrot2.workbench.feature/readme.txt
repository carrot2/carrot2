...
The DCW requires a Java Runtime Environment (JRE) version 1.8 (will not
work with any subsequent Java release). To start the DCW, run 
carrot2-workbench.exe (Windows), carrot2-workbench (Linux)

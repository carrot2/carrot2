...
/** */
public class CzechLanguageComponents extends LanguageComponentsProviderImpl {
  public static final String NAME = "Czech";

  public CzechLanguageComponents() {
  ...
  public Map<Class<?>, Supplier<?>> load(String language, ResourceLookup resourceLookup)
    ...
    components.put(Stemmer.class, () -> new LuceneStemmerAdapter(new CzechStemmer()::stem));

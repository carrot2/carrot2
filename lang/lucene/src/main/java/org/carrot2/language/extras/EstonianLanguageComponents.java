...
/** */
public class EstonianLanguageComponents extends SingleLanguageComponentsProviderImpl {
  public static final String NAME = "Estonian";

  public EstonianLanguageComponents() {

...
/** */
public class BulgarianLanguageComponents extends SingleLanguageComponentsProviderImpl {
  ...
  public BulgarianLanguageComponents() {
    ...
    registerResourceless(Stemmer.class, LuceneAccessBypass::getBulgarianStemmer);
  }
}

...
import org.carrot2.language.SnowballStemmerAdapter;
import org.carrot2.language.Stemmer;
import org.carrot2.language.Tokenizer;
import org.carrot2.language.snowball.IrishStemmer;
...
public class IrishLanguageComponents extends LanguageComponentsProviderImpl {
  ...
  public Map<Class<?>, Supplier<?>> load(String language, ResourceLookup resourceLookup)
    ...
    components.put(Stemmer.class, () -> new SnowballStemmerAdapter(new IrishStemmer()));

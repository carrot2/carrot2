...
/** */
public class CroatianLanguageComponents extends SingleLanguageComponentsProviderImpl {
  public static final String NAME = "Croatian";

  public CroatianLanguageComponents() {

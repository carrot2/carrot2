...
final class SourceFile {
    ...
    public SourceFile(String fullFile, File file) {
        ...
        if (headerEnd < 0) {
            // No package? Complain.
            throw new RuntimeException("Header detection failed, no package statement in file: "
    ...
    /**
     * Canonicalize a header/ footer by removing trailing spaces
     * and normalizing EOLs.
     */
    ...
    /**
     * Returns <code>true</code> if this split is identical (in canonical
     * sense) to another.
     */

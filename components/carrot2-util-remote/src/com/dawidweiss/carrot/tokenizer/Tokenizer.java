...
public class Tokenizer
{
    ...
    /**
     * Token type representing  regular terms - word, hyphenated words (alpha-beta), even
     * single-letter conjunctions (i,a)
     */
    ...
    /**
     * Token type representing abbreviated names, for example G. Bush or S.C.Johnson. <em>If only
     * surname is present in the text, it will be returned as a <code>TYPE_TERM</code></em> token!
     */
    ...
    /**
     * Creates a new empty tokenizer, which has to be initialized using one of the restart methods.
     */
    ...
    /**
     * Return the next token from the parsing data. The token value is returned from the method,
     * while the type of the token is stored in the zero index of the input parameter

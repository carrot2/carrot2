...
public class QueryFilterComponent
{
     ...
     *
     * @param componentServiceURL An URL to where the component service point is (must accept HTTP
     *        POST)
     * @param carrotRequest The data stream to be sent in a POST request as "carrot-xchange-data"
     *        parameter.
    ...
    public InputStream queryInputComponent(
        URL componentServiceURL, Map params, InputStream carrotRequest
    )
        throws IOException
    {
    ...
    public static void main(String [] args)
    {
        ...
        try
        {
            while (i < args.length)
            {
                ...
                else
                {
                    ...
                    {
                        System.err.println(
                            "Input stream already defined, cannot accept option: " + args[i]
                        );
                    ...
                    System.err.println("Reading input from: " + args[i]);
        ...
        try
        {
            ...
            {
                System.err.println(
                    "Error in response (null returned from the HTTP POST submitter)"
                );
            }

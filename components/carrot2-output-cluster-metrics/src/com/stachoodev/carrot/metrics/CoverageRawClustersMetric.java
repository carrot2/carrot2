 ...
 * @version $Revision$
 */
public class CoverageRawClustersMetric implements RawClustersMetric
{
    /**
    ...
    /**
     * Returns a {@link Double}object representing category coverage for the
     * whole set of clusters.
     */
    public static final String METRIC_COVERAGE = "Coverage";
    ...
    public Map compute(List rawClusters, List originalRawClusters)
    {
        ...
        double coverage = coveredCategories
            / Math.sqrt(fullCoveragePosition * allCategories);

        Map metrics = new HashMap();
        metrics.put(METRIC_COVERAGE, new Double(coverage));

package com.dawidweiss.carrot.util.tokenizer.languages.german;
 ...
 * @version $Revision$
 */
public class German extends StemmedLanguageBase {
     ...
     */
    static {
        String resourceName = "stopwords.de";
        try {
	...
	/**
     * @return Language code: <code>de</code>

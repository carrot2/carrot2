/* Generated By:JavaCC: Do not edit this line. JavaCCWordBasedParserImplTokenManager.java */
package com.dawidweiss.carrot.util.tokenizer.parser.javacc;

public class JavaCCWordBasedParserImplTokenManager implements JavaCCWordBasedParserImplConstants
{
         ...
         MatchLoop: do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 43:
                  ...
                  break;
               case 44:
                  if ((0x400308000000000L & l) != 0L && kind > 8)
                     kind = 8;
                  break;
               case 45:
                  if ((0x3ff000000000000L & l) == 0L)
...
static final int[] jjnextStates = {
   50, 108, 109, 112, 113, 121, 122, 125, 131, 132, 51, 3, 4, 7, 20, 21, 
   24, 3, 4, 7, 4, 6, 7, 9, 10, 13, 19, 12, 13, 19, 7, 13, 
   15, 16, 7, 13, 16, 18, 7, 8, 13, 20, 21, 24, 21, 23, 24, 52, 
   69, 73, 76, 79, 82, 85, 88, 91, 92, 57, 58, 61, 67, 60, 61, 67, 
   55, 61, 63, 64, 55, 61, 64, 66, 55, 56, 61, 96, 97, 101, 107, 99, 
   100, 101, 101, 103, 104, 101, 104, 106, 114, 115, 116, 116, 119, 120, 121, 122, 
   125, 122, 124, 125, 133, 135, 140, 145, 135, 138, 140, 143, 135, 138, 144, 140, 
   143, 133, 135, 144, 140, 145, 110, 111, 147, 114, 115, 116, 133, 135, 140, 145, 
   117, 118, 136, 137, 
};
...
private final int[] jjstateSet = new int[300];
protected char curChar;
public JavaCCWordBasedParserImplTokenManager(SimpleCharStream stream)
{
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public JavaCCWordBasedParserImplTokenManager(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}

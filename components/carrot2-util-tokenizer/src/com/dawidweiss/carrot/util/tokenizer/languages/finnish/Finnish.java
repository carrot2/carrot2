...
package com.dawidweiss.carrot.util.tokenizer.languages.finnish;
 ...
 * for Finnish.
 */
public class Finnish extends StemmedLanguageBase {
     ...
     */
    static {
        String resourceName = "stopwords.fi";
        try {
            stopwords = WordLoadingUtils.loadWordSet(
                    resourceName, Finnish.class.getResourceAsStream(resourceName));
		} catch (IOException e) {
	...
	/**
     * @return Language code: <code>fi</code>

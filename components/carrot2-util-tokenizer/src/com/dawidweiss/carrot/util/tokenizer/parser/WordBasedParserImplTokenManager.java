/* Generated By:JavaCC: Do not edit this line. WordBasedParserImplTokenManager.java */
package com.dawidweiss.carrot.util.tokenizer.parser;

public class WordBasedParserImplTokenManager implements WordBasedParserImplConstants
{
...
static final int[] jjnextStates = {
   50, 108, 109, 111, 112, 118, 119, 122, 128, 129, 51, 3, 4, 7, 20, 21, 
   ...
   100, 101, 101, 103, 104, 101, 104, 106, 118, 119, 122, 119, 121, 122, 110, 133, 
   113, 114, 115, 116, 
};
...
public WordBasedParserImplTokenManager(SimpleCharStream stream)
{
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public WordBasedParserImplTokenManager(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}

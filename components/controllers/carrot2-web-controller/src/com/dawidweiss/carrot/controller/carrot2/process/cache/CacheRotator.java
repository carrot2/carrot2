...
package com.dawidweiss.carrot.controller.carrot2.process.cache;
...
public class CacheRotator
{
        ...
        throws ParserConfigurationException, IOException, SAXException
    {
        for (Iterator i = from.getCachedElementSignatures(); i.hasNext();)
        {
            ...
            CachedQuery q = (CachedQuery) from.getCachedElement(signature);
        ...
        throws IOException
    {
        ...
        {
            Object signature = i.next();
            CachedQuery q = (CachedQuery) source.getCachedElement(signature);
            CachedQuery q2 = (CachedQuery) dest.getCachedElement(signature);

...
package com.dawidweiss.carrot.controller.carrot2.process.cache.file;
...
import org.put.util.net.URLEncoding;
import java.io.*;
import java.util.*;
            ...
            while (true)
            {
                ...
                else if (b == -1)
                {
                    throw new IOException(
                        ...
                        + org.put.util.exception.ExceptionHelper.getCurrentStackTrace()
                    );
                }
                else
                {

...
public class ParseException extends Exception {
     ...
     * it.  If this object has been created due to a parse error, and you do
     * not catch it (it gets thrown from the parser), then this method is
     * called during the printing of the final stack trace, and hence the

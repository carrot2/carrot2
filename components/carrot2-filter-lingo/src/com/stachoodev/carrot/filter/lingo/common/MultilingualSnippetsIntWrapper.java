...
public class MultilingualSnippetsIntWrapper extends AbstractSnippetsIntWrapper {
    ...
    /**
     * @see com.stachoodev.carrot.filter.lingo.util.suffixarrays.wrapper.IntWrapper#reverse()
     */
    public void reverse() {
        super.reverse();
    ...
    protected class SplitSnippetsIntWrapper extends AbstractSnippetsIntWrapper {
        ...
        /**
         * @see com.stachoodev.carrot.filter.lingo.common.AbstractSnippetsIntWrapper#createIntData()
         */
        protected void createIntData() {

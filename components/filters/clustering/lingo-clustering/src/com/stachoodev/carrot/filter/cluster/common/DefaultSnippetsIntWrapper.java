 ...
 *
 */
public class DefaultSnippetsIntWrapper
    extends AbstractSnippetsIntWrapper
{
    ...
    /**
     * @param document document data. Sentences MUST be period-delimited, with a space character
     *        preceeding and succeeding the period. Subsequent words MUST be separated by a single
     *        space character.
     */
    ...
    /**
     * @see com.stachoodev.carrot.filter.cluster.common.AbstractSnippetsIntWrapper#clone()
     */
    public Object clone()
    {

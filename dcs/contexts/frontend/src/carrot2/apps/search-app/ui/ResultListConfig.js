...
export const ResultListConfig = view(({ children }) => {
  ...
  return (
    <>
      ...
      <FormGroup inline={true} label="Max chars per result" labelFor="max-chars-per-result">
        <NumericInput id="max-chars-per-result" min={0} value={store.maxCharsPerResult}

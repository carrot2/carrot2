...
const palettes = [
  [ 'hsl(60,100%,95%)', 'hsl(64,92%,86%)', 'hsl(78,72%,79%)',
    'hsl(96,54%,71%)', 'hsl(121,41%,62%)', 'hsl(136,45%,46%)',
    'hsl(140,58%,33%)', 'hsl(152,100%,20%)', 'hsl(156,100%,14%)' ],
  [ 'hsl(60,100%,95%)', 'hsl(53,100%,87%)', 'hsl(45,98%,78%)',
    'hsl(40,99%,65%)', 'hsl(32,99%,58%)', 'hsl(26,85%,50%)',
    'hsl(22,98%,40%)', 'hsl(19,95%,31%)', 'hsl(19,89%,21%)' ]
];

export const generatePalette = () => {
  return palettes[Math.floor(Math.random() * palettes.length) % palettes.length];
};
...
export const generateBackground = (canvas, colors) => {
  ...
  const sources = colors.slice(0).reverse().reduce(function (src, color, index) {

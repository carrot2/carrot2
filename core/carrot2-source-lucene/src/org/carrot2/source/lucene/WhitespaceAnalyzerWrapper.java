 ...
 */
@Root(name = "analyzer")
public final class WhitespaceAnalyzerWrapper 
    implements ISimpleXmlWrapper<WhitespaceAnalyzer>

{
    private WhitespaceAnalyzer analyzer;

    public WhitespaceAnalyzerWrapper()
    {
    }

    public WhitespaceAnalyzer getValue()
    {
        return analyzer;
    }

    public void setValue(WhitespaceAnalyzer value)
    {
        analyzer = value;
    }

...
public abstract class DoubleMatrix2D extends AbstractMatrix2D implements Cloneable {
   ...
   * <pre>
   * org.carrot2.mahout.math.function.Functions F = org.carrot2.mahout.math.function.Functions.functions;
   * 2 x 2 matrix
   * 0 1
   * 2 3
   *
   ...
   * 4 6
   *
   * m1.assign(m2, org.carrot2.mahout.math.function.Functions.pow);
   * -->
   * m1 == 2 x 2 matrix
   * 1   1
   * 16 729

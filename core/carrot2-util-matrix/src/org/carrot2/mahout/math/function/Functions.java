 ...
 * {@link org.carrot2.mahout.math.function.DoubleFunction}, binary functions of type {@link
 * org.carrot2.mahout.math.function.DoubleDoubleFunction}. All can be retrieved via <tt>public static final</tt>
 * variables named after the function. Unary predicates are of type
 * {@link org.carrot2.mahout.math.function.DoubleProcedure},
 * binary predicates of type {@link org.carrot2.mahout.math.function.DoubleDoubleProcedure}. All can be retrieved via
 ...
 * argument. See methods {@link #bindArg1(org.carrot2.mahout.math.function.DoubleDoubleFunction ,double)} and {@link
 * #bindArg2(org.carrot2.mahout.math.function.DoubleDoubleFunction ,double)}. The order of arguments can
 * be swapped so that the first argument becomes the
 * second and vice-versa. See method {@link #swapArgs(org.carrot2.mahout.math.function.DoubleDoubleFunction)}.
 ...
 * #chain(org.carrot2.mahout.math.function.DoubleFunction , org.carrot2.mahout.math.function.DoubleFunction)}:
 ...
 * #chain(org.carrot2.mahout.math.function.DoubleFunction , org.carrot2.mahout.math.function.DoubleDoubleFunction)}:
 * <ul> <li><tt>Functions.chain(g,f);</tt> </ul> The binary function
 * <tt>f(g(a),h(b))</tt> can be generated via
 * {@link #chain(org.carrot2.mahout.math.function.DoubleDoubleFunction , org.carrot2.mahout.math.function.DoubleFunction ,
 * org.carrot2.mahout.math.function.DoubleFunction)}: <ul>

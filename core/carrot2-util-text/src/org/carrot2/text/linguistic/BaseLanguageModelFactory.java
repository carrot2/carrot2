...
/**
 * A basic implementation of the {@link ILanguageModelFactory}. This implementation loads
 * and caches lexical resources (stop words, stop labels) for each supported language. All
 * {@link ILanguageModel}s produced by this factory use {@link IdentityStemmer} and
 * {@link ExtendedWhitespaceTokenizer}. For a factory of more advanced language models, 
 * please see {@link DefaultLanguageModelFactory}.
 * 
 * @see LanguageCode
 * @see DefaultLanguageModelFactory
 */
@Bindable(prefix = "DefaultLanguageModelFactory")
public class BaseLanguageModelFactory implements ILanguageModelFactory
{
    /**
     ...
     * instance has its own instance of {@link BaseLanguageModelFactory}).
     */
    ...
    {
        synchronized (BaseLanguageModelFactory.class)
        {
    ...
    /**
     * Provide an {@link ITokenizer} implementation for a given language.
     */

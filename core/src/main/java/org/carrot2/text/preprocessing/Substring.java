...
/**
 * Represents a general substring. Contains information on the substring's boundaries and absolute
 * frequency.
 */
final class Substring {
  ...
  public boolean isEquivalentTo(Substring other, int[] tokensWordIndex, int[] wordsStemIndex) {

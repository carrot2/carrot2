...
public interface FeatureScorer {
  /**
   * Returns scores for features from {@link PreprocessingContext#allLabels}. A neutral score is
   * 1.0. Anything below 1.0 will lower label score, anything above 1.0 will raise it.
   */

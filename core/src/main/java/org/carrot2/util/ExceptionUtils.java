...
public final class ExceptionUtils {
  ...
  /**
   * If <code>t</code> if an instance of <code>clazz</code>, then <code>t</code> is returned.
   * Otherwise an instance of <code>clazz</code> is created using a single-parameter constructor
   * accepting <code>t</code> and the wrapper exception instance is returned. If no matching

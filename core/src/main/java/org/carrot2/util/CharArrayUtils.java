...
public class CharArrayUtils {
  ...
  /** Returns <code>true</code> if the input array contains any capitalized characters. */
  ...
  /**
   * Convert to lower case (character-by-character) and save the result into <code>buffer</code>.
   *
   * @param word The word to be converted to lower case.
   * @param buffer The buffer where the result should be saved.
   * @return Returns <code>true</code> if at least one character was changed between <code>word
   *     </code> and <code>buffer</code>. <code>false</code> indicates an identical copy.
  ...
  /**
   * Convert to lower case (character-by-character) and save the result into <code>buffer</code>.
   * The buffer must have at least <code>length</code> characters.
   *
   * @param word The word to be converted to lower case.
   * @param buffer The buffer where the result should be saved.
   ...
   * @throws AssertionError If <code>start + length</code> is smaller than the length <code>word
   *     </code>.
   */

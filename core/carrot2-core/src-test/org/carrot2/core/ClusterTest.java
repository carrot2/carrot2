...
public class ClusterTest extends CarrotTestCase
{
    ...
    {
        final Cluster flatCluster = new Cluster();
        final List<Document> documents = new ArrayList<>(Arrays.asList(new Document(), new Document()));
    ...
    public void testSizeNonEmptyHierarchicalWithoutOverlap()
    {
        ...
        final List<Document> expectedAllDocuments = new ArrayList<>(Arrays.asList(documentA, documentB));
    ...
    public void testSizeNonEmptyHierarchicalWithOverlap()
    {
        ...
        final List<Document> expectedAllDocuments = org.carrot2.util.GuavaReplace.newArrayList(document1,
            documentB, documentC);
    ...
    public void testByLabelComparator()
    {
        ...
        checkOrder(org.carrot2.util.GuavaReplace.newArrayList(clusterNull, clusterA, clusterB),
    ...
    public void testBySizeComparator()
    {
        ...
        checkOrder(new ArrayList<>(Arrays.asList(clusterB, clusterA)), Cluster.BY_SIZE_COMPARATOR);
    }
    ...
    public void testByReversedSizeAndLabelComparator()
    {
        ...
        checkOrder(org.carrot2.util.GuavaReplace.newArrayList(clusterC, clusterA, clusterB),
    ...
    public void testNoIdentifiers()
    {
        ...
        Cluster.assignClusterIds(org.carrot2.util.GuavaReplace.newArrayList(d1, d2, d3));
    ...
    public void testSubclusterIdentifiers()
    {
        ...
        Cluster.assignClusterIds(new ArrayList<>(Arrays.asList(d1, d3)));
        assertThat(d1.id).isEqualTo(0);
        assertThat(d2.id).isEqualTo(1);
    ...
    public void testSomeIdentifiers()
    {
        ...
        Cluster.assignClusterIds(org.carrot2.util.GuavaReplace.newArrayList(d1, d2, d3, d4, d5));
    }
    ...
    public void testNonUniqueIdentifiers()
    {
        ...
        Cluster.assignClusterIds(new ArrayList<>(Arrays.asList(d1, d2)));
    }
    ...
    public void testFindRootCluster()
    {
        ...
        Assertions.assertThat(Cluster.find(1, new ArrayList<>(Arrays.asList(c1, c2)))).isSameAs(c2);
    }
    ...
    public void testFindSubcluster()
    {
        ...
        Assertions.assertThat(Cluster.find(2, new ArrayList<>(Arrays.asList(c1)))).isSameAs(c3);
    }
    ...
    public void testFindNotFound()
    {
        ...
        Assertions.assertThat(Cluster.find(3, new ArrayList<>(Arrays.asList(c1)))).isNull();
    }
    ...
    public void testBuildOtherTopicsNonAssigned()
    {
        ...
        final List<Document> allDocuments = org.carrot2.util.GuavaReplace.newArrayList(d1, d2, d3);

        final Cluster c1 = new Cluster();
        final Cluster c2 = new Cluster();
        final Cluster c3 = new Cluster();
        c2.addSubclusters(c3);
        final List<Cluster> clusters = new ArrayList<>(Arrays.asList(c1, c2));
    ...
    public void testBuildOtherTopicsSomeAssigned()
    {
        ...
        assertThatDocuments(otherTopics.getDocuments()).isEquivalentTo(new ArrayList<>(Arrays.asList(d1, d3)));
    }

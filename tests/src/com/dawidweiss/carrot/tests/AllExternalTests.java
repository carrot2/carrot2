...
/**
 * Performs all external test cases in the required order.
 * Can be run from command line as well as from JUnit runner.
 */
    ...
    extends TestSuite
{
    ...
    /**
     * Helpful if tests are to be run from command line. The
     * tests are invoked using junit's command line runner. 
     */

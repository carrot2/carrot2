...
public abstract class IterativeMatrixFactorizationFactory extends AttrComposite implements IMatrixFactorizationFactory {
   ...
   */
  public final AttrEnum<FactorizationQuality> factorizationQuality = attributes.register(
      "factorizationFactory", AttrEnum.builder(FactorizationQuality.class).label(
          "Factorization quality").defaultValue(FactorizationQuality.HIGH));
  ...
  public void estimateIterationsNumber(int dimensions, DoubleMatrix2D termDocumentMatrix) {
    ...
    double[] coefficients = allKnownCoefficients.get(Arrays.asList(this.getClass(),
                                                                   this.getSeedingFactory().getClass(),
                                                                   factorizationQuality.get()));
    ...
    if (coefficients != null) {
      ...
      if (columns < 50 || columns > 400 || getK() < 5 || getK() > 50) {
        ...
        int iterations = (int) (columns * coefficients[0] + getK() * coefficients[1] + coefficients[2]);
  ...
  static {
    ...
    allKnownCoefficients.put(Arrays.asList(NonnegativeMatrixFactorizationEDFactory.class,
                                           RandomSeedingStrategyFactory.class,
                                           FactorizationQuality.LOW), new double[] {-0.0166,
        0.3333, 8.0000});

    /* NMF-ED, Random seeding, level 2 */
    allKnownCoefficients.put(Arrays.asList(NonnegativeMatrixFactorizationEDFactory.class,
                                           RandomSeedingStrategyFactory.class,
                                           FactorizationQuality.MEDIUM), new double[] {-0.0175
        , 0.6, 12.0});

    /* NMF-ED, Random seeding, level 3 */
    allKnownCoefficients.put(Arrays.asList(NonnegativeMatrixFactorizationEDFactory.class,
                                           RandomSeedingStrategyFactory.class,
                                           FactorizationQuality.HIGH), new double[] {-0.0186,
        0.8222, 17.3555});

    /* NMF-KL, Random seeding, level 1 */
    allKnownCoefficients.put(Arrays.asList(NonnegativeMatrixFactorizationKLFactory.class,
                                           RandomSeedingStrategyFactory.class,
                                           FactorizationQuality.LOW), new double[] {-0.0166,
        0.3333, 8.0000});
    ...
    allKnownCoefficients.put(Arrays.asList(NonnegativeMatrixFactorizationEDFactory.class,
                                           ...
                                           FactorizationQuality.LOW), new double[] {-0.005, 0,
        6});

    /* NMF-ED, KMeans seeding, level 2 */
    allKnownCoefficients.put(Arrays.asList(NonnegativeMatrixFactorizationEDFactory.class,
                                           KMeansSeedingStrategyFactory.class,
                                           FactorizationQuality.MEDIUM), new double[] {-0.005,
        0, 10});

    /* NMF-ED, KMeans seeding, level 3 */
    allKnownCoefficients.put(Arrays.asList(NonnegativeMatrixFactorizationEDFactory.class,
                                           KMeansSeedingStrategyFactory.class,
                                           FactorizationQuality.HIGH), new double[] {-0.005, 0
        , 20});

    /* LNMF, Random seeding, level 1 */
    allKnownCoefficients.put(Arrays.asList(LocalNonnegativeMatrixFactorizationFactory.class,
                                           RandomSeedingStrategyFactory.class,
                                           FactorizationQuality.LOW), new double[] {-0.014,
        0.1, 7.5});
    ...
    allKnownCoefficients.put(Arrays.asList(LocalNonnegativeMatrixFactorizationFactory.class,
                                           RandomSeedingStrategyFactory.class,
                                           FactorizationQuality.HIGH), new double[] {-0.02333,
        0.2, 16.8888});
  }
}

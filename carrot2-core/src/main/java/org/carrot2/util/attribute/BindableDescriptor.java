...
public class BindableDescriptor
{
        ...
        Map<String, AttributeDescriptor> attributeDescriptors, GroupingMethod groupBy)
    {
        ...
        final LinkedHashMap<String, AttributeDescriptor> newAttributeDescriptors = new LinkedHashMap<>();
        final LinkedHashMap<Object, Map<String, AttributeDescriptor>> newAttributeGroups = new LinkedHashMap<>();
    ...
    {
        final Map<String, AttributeDescriptor> filteredAttributeDescriptors = new LinkedHashMap<>();
        ...
        final Map<Field, BindableDescriptor> filteredBindableDescriptors = new LinkedHashMap<>();
    ...
    public final BindableDescriptor not(final Class<? extends Annotation>... annotationClasses)
    {
        ...
        return only(new AnnotationsPredicate(false, annotationClasses).negate());
    }
    ...
    {
        final Map<Object, Map<String, AttributeDescriptor>> unsortedGroups = new HashMap<>();
        ...
        if (GroupingMethod.STRUCTURE.equals(groupingMethod))
        {
            ...
            sortedGroupKeys = new ArrayList<>(unsortedGroups.keySet());
    ...
    static IGrouper<Class<?>> GROUPER_BY_STRUCTURE =
        (bindableDescriptor, attributeDescriptor) -> attributeDescriptor.attributeField.getDeclaringClass();

    static IGrouper<AttributeLevel> GROUPER_BY_LEVEL =
        (bindableDescriptor, attributeDescriptor) -> {
    ...
    static IGrouper<String> GROUPER_BY_GROUP = (bindableDescriptor, attributeDescriptor) -> {
        if (attributeDescriptor.metadata != null)
        {
    ...
    static IGrouper<String> GROUPER_BY_NONE = (bindableDescriptor, attributeDescriptor) -> null;

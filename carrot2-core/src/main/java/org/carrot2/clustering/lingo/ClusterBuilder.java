...
public class ClusterBuilder extends AttrComposite {
     ...
     */
    public AttrDouble phraseLabelBoost = attributes.register("phraseLabelBoost", AttrDouble.builder()
     ...
     */
    public AttrInteger phraseLengthPenaltyStart = attributes.register("phraseLengthPenaltyStart", AttrInteger.builder()
     ...
     */
    public AttrInteger phraseLengthPenaltyStop = attributes.register("phraseLengthPenaltyStop", AttrInteger.builder()
     ...
     */
    public AttrDouble clusterMergingThreshold = attributes.register("clusterMergingThreshold", AttrDouble.builder()

...
public class ExtendedWhitespaceTokenizerTest extends TokenizerTestBase {
  ...
  public void testUrlTokens() {
    ...
    TokenImage[] tokens = {
        ...
        new TokenImage("http://www.cs.put.poznan.pl/index.jsp?query=term&query2=term", Tokenizer.TT_FULL_URL),
        ...
        new TokenImage("http://www.herold.at/gelbe-seiten/krems-an-der-donau/lDk8q/yoga-krems-wachau-j%C3%BCrgen-ullrich/", Tokenizer.TT_FULL_URL),
  ...
  public void testKoreanWordSplit() {
    ...
    TokenImage[] tokens = {
        new TokenImage("안녕하세요", Tokenizer.TT_TERM),
        new TokenImage("한글입니다", Tokenizer.TT_TERM),
    };

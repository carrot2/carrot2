 ...
 */
public class LabelFormatterTest extends AbstractTest {
  /**
  ...
  public void testPhraseWithLowerCaseWords() {
    Stream<TestDocument> documents = Stream.of(
        new TestDocument("test phrase", "test phrase"));
  ...
  public void testPhraseWithStopWords() {
    Stream<TestDocument> documents = Stream.of(
        new TestDocument("food for fish", "food for fish"));
  ...
  public void testPhraseWithoutStopWords() {
    Stream<TestDocument> documents = Stream.of(
        new TestDocument("Jaguar car", "Jaguar car"));
  ...
  public void testPhraseWithCapitalizedWords() {
    Stream<TestDocument> documents = Stream.of(
        new TestDocument("iMac stuff", "iMac stuff"));
  ...
  public void testChinesePhrases() {
    Stream<TestDocument> documents = Stream.of(
        new TestDocument("东亚货币贬值", "东亚货币贬值"));
  ...
  private void checkWithoutPreprocessing(char[][] words, boolean[] stopWords,
    ...
    Assertions.assertThat(LabelFormatter.format(words, stopWords, joinWithSpace)).isEqualTo(expectedFormattedLabel);
  }

  private void checkFullPreprocessing(Stream<? extends Document> documents,
                                      LanguageComponents langComponents, String... expectedFormattedLabels) {

...
public class PreprocessedDocumentScannerTest extends TestBase {
  ...
  public void testEmpty() {
    check(Stream.empty(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
  }
  ...
  public void testOneDocumentOneFieldOneSentence() {
    ...
    check(Stream.of(new TestDocument("test")),
        expectedDocumentRanges, expectedFieldRanges, expectedSentenceRanges);
  }
  ...
  public void testOneDocumentOneFieldMoreSentences() {
    ...
    check(Stream.of(new TestDocument("test1 . test2 . test3")),
        expectedDocumentRanges, expectedFieldRanges, expectedSentenceRanges);
  }
  ...
  public void testOneDocumentMoreFieldsMoreSentences() {
    ...
    check(Stream.of(new TestDocument("test1 . test2 . ", "test3 . test4")),
        expectedDocumentRanges, expectedFieldRanges, expectedSentenceRanges);
  }
  ...
  public void testMoreDocumentsMoreFieldsMoreSentences() {
    ...
    check(Stream.of(
        new TestDocument("test1", "test2 . test3"),
        new TestDocument("test4", "test5 . test6")),
        expectedDocumentRanges, expectedFieldRanges, expectedSentenceRanges);
  }

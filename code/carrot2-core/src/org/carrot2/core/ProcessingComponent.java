...
public interface ProcessingComponent
{
     ...
     * marked with {@link Processing} and {@link Output} annotations will be collected. In
     * this method, the processing component should dispose of any resources it has
     * allocated to fulfill the request. No matter whether a call to this method completes

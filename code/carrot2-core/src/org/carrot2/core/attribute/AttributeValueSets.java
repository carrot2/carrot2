...
public class AttributeValueSets
{
    ...
    public void removeAttributeValueSet(String id)
    {
        ...
        for (AttributeValueSet set : attributeValueSets.values())
        {
    ...
    private void updateBaseAttributeValueSetIds()
    {
        ...
        outer: for (AttributeValueSet attributeValueSet : attributeValueSets.values())
        {
            ...
            for (Map.Entry<String, AttributeValueSet> entry : attributeValueSets
                .entrySet())
            {
    ...
    {
        for (AttributeValueSet attributeValueSet : attributeValueSets.values())
        {

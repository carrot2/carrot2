...
public class ConstraintUtils
{
    ...
    public static Class<?> [] getImplementingClasses(Constraint constraint)
    {
        ...
        {
            Set<Constraint> constraints = ((CompoundConstraint) constraint)
                .getConstraints();
            for (Constraint partialConstraint : constraints)
            {
                Class<?> [] implementingClasses = getImplementingClasses(partialConstraint);

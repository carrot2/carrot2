...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="user-active-source" select="/page/request/cookie[@key = 'active-source']/value" />
  ...
  <xsl:template match="page" mode="sources-internal">
    <xsl:variable name="source-order" select="/page/request/cookie[@key = 'source-order']/value" />
    <xsl:choose>

...
public class WebappConfig
{
    ...
    final static DocumentSourceModel YAHOO_NEWS = new DocumentSourceModel(
        ...
        "Yahoo News description", Lists.immutableList("election", "iphone", "poland"));
    ...
    @Attribute(name = "minify-assets")
    public final boolean minifyAssets = true;

    @Attribute(name = "query-param")
    public final static String QUERY_PARAM = AttributeNames.QUERY;
    
    @Attribute(name = "size-param")
    public final static String SIZE_PARAM = AttributeNames.RESULTS;

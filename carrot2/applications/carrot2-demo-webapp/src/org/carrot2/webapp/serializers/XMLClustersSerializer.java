...
public class XMLClustersSerializer implements RawClustersSerializer {
        ...
        throws IOException
    {
        ...
        emitCookieBasedProcessingInstructions(writer, request);
    ...
    private void emitCookieBasedProcessingInstructions(Writer writer,
        HttpServletRequest request) throws IOException
    {
        ...
        {
            if (Constants.COOKIE_SHOW_ALL_CLUSTERS.equals(cookies[i].getName()))
            {
                writer.write("<?more-increment nolimit ?>\n");
            }
        }
    }
    ...
    public final void endResult(long clusteringTime) throws IOException {
        ...
        try {
            writer.write("<time clustering=\"" + clusteringTime + "\" />");
    ...
    private final void collect(RawCluster cluster, String parentWordIds,
        String parentLabel) throws IOException
    {
        ...
        buffer.append("\"");
        buffer.append(" words=\"");
        String wordidsString = createWordidsString(cluster, parentWordIds);
        ...
        for (Iterator i = subgroups.iterator(); i.hasNext();) {
            ...
            collect(subgroup, wordidsString, newParentLabel);
        }
    ...
    private String createWordidsString(RawCluster cluster,
            final String parentWordIds)
    {

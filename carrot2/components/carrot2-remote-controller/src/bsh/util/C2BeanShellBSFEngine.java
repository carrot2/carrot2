 ...
 * 
 * @author Pat Niemeyer
 * @author Dawid Weiss (exception propagation fix).
 */
public class C2BeanShellBSFEngine extends BSFEngineImpl
{
	private Interpreter interpreter;
	private boolean installedApplyMethod;

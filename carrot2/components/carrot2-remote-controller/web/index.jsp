<%@page contentType="text/html; charset=UTF-8" 
        errorPage="/error.jsp"
        import="com.dawidweiss.carrot.util.net.*"
%>

<%@include file="jsp-tmpl/prolog-base.txt" %>

<jsp:useBean id="queryBean" scope="request" class="com.dawidweiss.carrot.remote.controller.struts.forms.QueryForm" />
...
<%
    ...
    buf.append("query="); buf.append( URLEncoding.encode(queryBean.getQuery(), "UTF-8"));
    buf.append('&');
    if (queryBean.getProcessingChain() != null)
    {
        buf.append("processingChain="); buf.append( URLEncoding.encode(queryBean.getProcessingChain(), "UTF-8"));
        buf.append('&');
    }

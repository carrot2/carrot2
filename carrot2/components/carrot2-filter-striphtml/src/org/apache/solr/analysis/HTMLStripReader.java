/* BORROWED FROM THE SOLR PROJECT. http://lucene.apache.org/solr/ */
 ...
 *
 * @author yonik
 * @version Id: HTMLStripReader.java 472574 2006-11-08 18:25:52Z yonik
 */
public final class HTMLStripReader extends Reader {
...
***/
  ...
  private int readEntity() throws IOException {
    ...
    if (ch==';') {
      ...
      Character entityChar = (Character) entityTable.get(entity);
      if (entityChar!=null) {
  ...
  ***/
  ...
  private static final HashMap entityTable;
  static {

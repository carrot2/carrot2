...
public class SnippetTokenizer
{
    ...
    /** */
    private static org.carrot2.core.linguistic.tokens.Token [] tokens;
    ...
    public SnippetTokenizer()
    {
        ...
        tokens = new org.carrot2.core.linguistic.tokens.Token [TOKEN_BUFFER_SIZE];
    }
        ...
        LanguageTokenizer languageTokenizer, int maxLength)
    {
        ...
        int tokenCount = 0;
        org.carrot2.core.linguistic.tokens.Token [] tokens = new org.carrot2.core.linguistic.tokens.Token [TOKEN_BUFFER_SIZE];

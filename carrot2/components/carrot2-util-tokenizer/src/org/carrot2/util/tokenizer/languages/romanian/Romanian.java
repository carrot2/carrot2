...
package org.carrot2.util.tokenizer.languages.romanian;
 ...
 * @author Dawid Weiss
 */
public class Romanian extends StemmedLanguageBase {
    ...
    static {
        try {
            stopwords = WordLoadingUtils.loadWordSet("stopwords.ro");
        } catch (IOException e) {

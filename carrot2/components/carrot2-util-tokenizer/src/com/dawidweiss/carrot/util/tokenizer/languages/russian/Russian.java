...
package com.dawidweiss.carrot.util.tokenizer.languages.russian;
 ...
 * for Russian.
 */
public class Russian extends StemmedLanguageBase {
     ...
     */
    static {
        String resourceName = "stopwords.ru";
        try {
            stopwords = WordLoadingUtils.loadWordSet(
                    resourceName, Russian.class.getResourceAsStream(resourceName));
		} catch (IOException e) {

 ...
 * @version $Revision$
 */
public class CoverageRawClustersMetricTest extends TestCase
{
    ...
    {
        super.setUp();
        rawClustersMetric = new CoverageRawClustersMetric();
    }
    ...
    public void testOnePredominantCatid()
    {
        ...
        assertEquals(
            ...
            "12",
            rawCluster
                .getProperty(CoverageRawClustersMetric.PROPERTY_CLUSTER_PREDOMINANT_CATID));
    }
    ...
    public void testIncompleteCoverage()
    {
        ...
        expectedMetrics.put(CoverageRawClustersMetric.METRIC_COVERAGE,

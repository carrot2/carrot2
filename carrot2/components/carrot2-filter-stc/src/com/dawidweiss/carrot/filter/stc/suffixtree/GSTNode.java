    ...
    extends Node
{
    ...
    /** Protected constructor binds this object to the container GeneralizedSuffixTree object */
    ...
    /**
     * Adds an edge to this object's subnodes links and propagates subnodes' indexed elements
     * up the tree.
     */
    ...
    /**
     * Every suffix inserted in a GST creates a path from root to a leaf. This function returns
     * the number of elements which have paths going through this node.
     */
    ...
    /**
     * Returns the internal representation of suffixed elements (an ExtendedBitSet).
     * This is carrot-only utility method for counting the intersection of suffixed
     * documents of two nodes.
     */

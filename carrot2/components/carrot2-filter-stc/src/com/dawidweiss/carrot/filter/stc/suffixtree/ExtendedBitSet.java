 ...
 * features. I had to copy-paste the code from JDK 1.3's java.util.BitSet because
 * I needed access to private fields of it. I don't know if it violates any of
 * Sun's licences - if so, the class will have to be rewritten in the future. Below
 * is the original Sun's javadoc for BitSet - please notice that ALL references and
 * functions arguments have been replaced with ExtendedBitSet instead of BitSet (regardless
 * of what the documentation in this file might say).
 *
    ...
    implements Cloneable, java.io.Serializable
{
    ...
    /**
     * Returns the number of set bits in a bitset which would
     * be created after XOR operation of argument and this ExtendedBitSet.
     * @return number of set bits in (this ^ set).
     */
    ...
    /**
     * Returns the number of set bits in a bitset which would
     * be created after AND operation of this ExtendedBitSet and the argument passed.
     * @return number of set bits in (this & set).
     */
    ...
    /**
     * Bitset iterator class. The current implementation is very naive - iteration
     *  over all bits of this bitset. Some optimizations would be useful.
     *  This iterator is not fail-safe!.
     */
    protected class BitsetIterator
        implements Iterator
    {
    ...
    /**
     * Returns the Iterator over indices of set bits in this object. The iterator
     * is not fail-safe.
     */

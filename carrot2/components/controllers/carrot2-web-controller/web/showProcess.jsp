<%@page contentType="text/html; charset=UTF-8"
        errorPage="/error.jsp"
        import="com.dawidweiss.carrot.controller.carrot2.process.*,com.dawidweiss.carrot.controller.carrot2.xmlbinding.componentDescriptor.*,java.util.Iterator,com.dawidweiss.carrot.controller.carrot2.Carrot2InitServlet,com.dawidweiss.carrot.*,com.dawidweiss.carrot.controller.carrot2.struts.StrutsHelpers"
%>
...
<logic:present name="process" scope="request">
	...
	<% if (p.isScripted()) { %>
		...
		<textarea cols="75" rows="25" readonly="true" style="color: #606060" WRAP="OFF"><%
			out.print(
				org.put.util.text.HtmlHelper.escapeHtmlTags(
					((ResolvedScriptedProcess) p).getScript()));
		%></textarea>
		<% } %>
	<% } else { %>

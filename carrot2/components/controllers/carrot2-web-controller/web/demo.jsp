<%@page contentType="text/html; charset=UTF-8"
        errorPage="/error.jsp"
        import="com.dawidweiss.carrot.controller.carrot2.xmlbinding.componentDescriptor.*,org.put.util.text.*,com.dawidweiss.carrot.controller.carrot2.struts.*,java.util.*,com.dawidweiss.carrot.controller.carrot2.struts.StrutsHelpers,com.dawidweiss.carrot.controller.carrot2.process.cache.file.*,com.dawidweiss.carrot.controller.carrot2.process.cache.*,com.dawidweiss.carrot.controller.carrot2.process.*,com.dawidweiss.carrot.controller.carrot2.*"
%>
...
<%
    ...
    for (Iterator i = precachedQueries.iterator(); i.hasNext();)
    {
        ...
        for (Iterator j = queries.iterator(); j.hasNext();)
        {
            ...
            out.write(
                  "<li><b>"
                + HtmlHelper.escapeHtmlTags(q.getQuery().getContent()) + "</b>");
            out.write(
                    "&nbsp;&nbsp;<i>"
                ...
                if (p.usesComponent(component))
                {
                    ...
                    %>
                        <a href="<%= response.encodeURL(
                            ...
                            + "query=" + org.put.util.net.URLEncoding.encode(q.getQuery().getContent(), "UTF-8")

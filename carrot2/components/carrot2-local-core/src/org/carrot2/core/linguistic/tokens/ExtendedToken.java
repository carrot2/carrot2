...
public class ExtendedToken implements Token, PropertyProvider
{
     ...
     * {@link org.carrot2.core.linguistic.tokens.Token}.
     * 
     * @param token
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.carrot2.core.linguistic.tokens.Token#appendTo(java.lang.StringBuffer)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.carrot2.core.linguistic.tokens.Token#getImage()
     */

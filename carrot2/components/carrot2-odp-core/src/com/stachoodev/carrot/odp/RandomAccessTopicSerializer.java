    ...
    LocationFactory
{
     ...
     * (non-Javadoc)
     * 
     * @see com.stachoodev.carrot.odp.TopicSerializer#initialize(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.stachoodev.carrot.odp.TopicSerializer#dispose()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.stachoodev.carrot.odp.index.LocationFactory#createLocation()
     */
    ...
    public static class RandomAccessLocation implements Location
    {
         ...
         * (non-Javadoc)
         * 
         * @see com.stachoodev.carrot.odp.index.Location#serialize(java.io.ObjectOutputStream)
         */
         ...
         * (non-Javadoc)
         * 
         * @see com.stachoodev.carrot.odp.index.Location#deserialize(java.io.ObjectOutputStream)
         */

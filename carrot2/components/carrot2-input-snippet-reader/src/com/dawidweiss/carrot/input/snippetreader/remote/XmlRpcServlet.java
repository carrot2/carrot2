...
/**
 * Main SnippetReader servlet. Serves POST requests  (XMLRPC and Carrot2,
...
public class XmlRpcServlet extends javax.servlet.http.HttpServlet {
    ...
    /**
     * This class is exposed as a 'meta' information provider. It, among
     * others, is capable of telling what other services have been registered
     * and are available.
     */
    protected class ServiceMetaInfo {
        ...
        public Vector getVerboseServicesList() {
            ...
            for (Iterator i = services.iterator(); i.hasNext();) {
                ...
                serviceAttrs.put("class",
                    registeredServices.get(serviceName).getClass().getName());
                ...
                for (int j = 0; j < methods.length; j++) {
                    if (Modifier.isPublic(methods[j].getModifiers())) {
                        serviceAttrs.put("public method: " +
        ...
        public String getServiceConfig(String service)
            ...
            if (f != null) {
                ...
                byte[] b = StreamUtils.readFullyAndCloseInput(is);
    ...
    public void init(ServletConfig servletConfig) throws ServletException {
        ...
        try {
            ...
            File servicesDir = new File(servletConfig.getServletContext()
                                                     .getRealPath(servicesPath));
            ...
            File[] services = servicesDir.listFiles(new java.io.FilenameFilter() {
            ...
            for (int i = 0; i < services.length; i++) {
                try {
                    ...
                    log.error("Exception when adding service: " +
                        services[i].getName(), e);
                }
            }
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        if ((method != null) && method.startsWith("/carrot2")) {
            ...
            if ((service == null) || !(service instanceof WebSnippetReader)) {
                ...
                res.getOutputStream().write(("Service " + service +
                ...
                try {
                    ...
                    ((WebSnippetReader) service).getSnippetsAsCarrot2XML(w,
                        query.getContent(),
                        query.hasRequestedResults()
                        ? query.getRequestedResults() : 100);
    ...
    /**
     * Return an information page in return for a  GET request (a regular
     * browser may issue such request).
     */

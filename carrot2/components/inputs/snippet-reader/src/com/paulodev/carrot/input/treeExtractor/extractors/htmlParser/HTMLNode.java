    ...
    implements HTMLTokenWriter
{
    ...
    public boolean match = false; // if it's a match
    ...
    public String toString()
    {
        ...
        if (isStandalone(name) && (children == null))
        {
            return sb.toString();
        }
    ...
    public void openingTag(StringBuffer sb)
    {
        if (!hidden)
        {
            ...
            if (match)
            {
                sb.append(" STYLE='background-color : Silver;' ");
            }
...
//        sb.append(" STYLE='background-color : Silver;' ");
    ...
    public void childrenTags(StringBuffer sb)
    {
        ...
        if (
            ((name == null) || !name.equals("script")) && (children != null)
                && (children.size() > 0)
        )
        {
    ...
    {
        "area", "base", "basefont", "bgsound", "br", "col", "dd", "dl", "dt", "frame", "hr", "img",
        "input", "isindex", "link", "meta", "nextid", "option", "overlay", "param", "tab", "wbr",
        "!", "!--"
    };

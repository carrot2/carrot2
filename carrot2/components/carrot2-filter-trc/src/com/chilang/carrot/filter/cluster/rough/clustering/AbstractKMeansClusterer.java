...
import com.chilang.carrot.filter.cluster.rough.filter.ngram.NGram;
import com.chilang.carrot.filter.cluster.rough.filter.ngram.NGramCollector;
import com.chilang.carrot.filter.cluster.rough.measure.Similarity;
import com.chilang.util.*;
...
public abstract class AbstractKMeansClusterer extends AbstractClusterer{
    ...
    protected final com.chilang.util.Timer timer = new com.chilang.util.Timer();

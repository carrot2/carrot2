...
import org.carrot2.filter.trc.carrot.filter.cluster.rough.clustering.ClusterRepresentative;
...
import org.carrot2.filter.trc.carrot.filter.cluster.rough.transformer.Snippet2DocumentTransformer;
import org.carrot2.filter.trc.carrot.filter.cluster.rough.transformer.Transformer;
import org.carrot2.filter.trc.carrot.filter.cluster.rough.weighting.TfIdfWeighting;
import org.carrot2.filter.trc.carrot.filter.cluster.rough.weighting.WeightingScheme;
import org.carrot2.filter.trc.util.ArrayUtils;
import org.carrot2.filter.trc.util.MathUtils;
